...
DynamoDB.prototype.define = function (descr) {
  ...
  this._models[modelName].ReadCapacityUnits = descr.settings.ReadCapacityUnits;
  this._models[modelName].WriteCapacityUnits = descr.settings.WriteCapacityUnits;
  ...
  // Assign table name
  tableParams.TableName = descr.settings.tableName || descr.model.modelName;
...
function DynamoFromJSON(data) {
  ...
  if (data instanceof Array) {
    ...
    data.forEach(function (dataElement) {
      ...
      // "null".
      if ((dataElement instanceof String) && (dataElement == "")) {
        dataElement = "null";
      }
  ...
  if (data instanceof Object) {
    ...
    for (var key in data) {
      if (data.hasOwnProperty(key)) {
        ...
        if ((attributeSpecs[key] === "string") && (obj[key] === "null")) {
          obj[key] = "";
        }

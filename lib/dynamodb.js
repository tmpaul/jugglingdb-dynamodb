  ...
  for (var key in properties) {
    ...
    if (properties[key].breaker) {
       /*
        ...
        of breaker
       */
      if (!this._models[modelName].breakable) {
         this._models[modelName].breakable = [];
         this._models[modelName].breakValue = [];
         this._models[modelName].breakable.push(key);
         this._models[modelName].breakValue.push(properties[key].breaker);
      } else {
         this._models[modelName].breakable.push(key);
         this._models[modelName].breakValue.push(properties[key].breaker);
      }
